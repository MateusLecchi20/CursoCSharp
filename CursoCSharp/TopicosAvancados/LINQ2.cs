namespace CursoCSharp.TopicosAvancados
{
    class LINQ2
    {
        public static void Executar()
        {
            ...
            if (sicrano == null)
            {
                Console.WriteLine("Aluno Inexiste!");
            }
            ...
            var mediaDaTurmaTotal = alunos.Average(aluno => aluno.Nota);
            Console.WriteLine(mediaDaTurmaTotal);
            
            var mediaDaTurmaAprovada = alunos.Where(a => a.Nota >= 7).Average(aluno => aluno.Nota);
            Console.WriteLine(mediaDaTurmaAprovada);
        }
    }
}